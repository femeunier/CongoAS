...
# devtools::install_github("femeunier/epwshiftr")
library(epwshiftr)
library(dplyr)
...
# scp /home/femeunier/Documents/projects/CongoAS/scripts/Download.IPSL.R hpc:/kyukon/data/gent/vo/000/gvo00074/felicien/R
